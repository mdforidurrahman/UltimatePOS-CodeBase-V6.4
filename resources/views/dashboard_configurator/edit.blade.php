...
<section class="content-header">
	<h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">
		@lang('lang_v1.configure_dashboard', ['name' => $dashboard->name])</h1>
</section>
...
<section class="content">
	...
	{!! Form::open([
	'url' => action(
		[\App\Http\Controllers\DashboardConfiguratorController::class, 'update'],
		['id' => $dashboard->id]
	),
	'method' => 'put'
])!!}
	@csrf
	<input type="hidden" name="configuration" id="configuration_input"
		...
		<div class="mt-10">
			...
			<div class="row">
				<button class="btn btn-default btn-block" type="button" data-toggle="collapse"
					data-target=".row_options" aria-expanded="false" aria-controls="collapseExample" id="add_row">
